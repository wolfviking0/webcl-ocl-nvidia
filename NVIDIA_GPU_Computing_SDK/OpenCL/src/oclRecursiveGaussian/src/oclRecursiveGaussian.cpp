...
unsigned int uiImageWidth = 1024;   // Image width
unsigned int uiImageHeight = 1024;  // Image height
...
int iGraphicsWinHeight = 1024;      //((float)uiImageHeight / (float)uiImageWidth) * iGraphicsWinWidth;  // GL Windows height
...
void InitGL(int* argc, char **argv)
{
    ...
    //glutInitWindowPosition (glutGet(GLUT_SCREEN_WIDTH)/2 - iGraphicsWinWidth/2, glutGet(GLUT_SCREEN_HEIGHT)/2 - iGraphicsWinHeight/2);
    //glutInitWindowSize(iGraphicsWinWidth, iGraphicsWinHeight);
    glutInitWindowSize(uiImageWidth, uiImageHeight);
    ...
    printf("Toggle Filter On/Off <spacebar>\n");
    printf("Toggle Processing between GPU and CPU [p]\n");
    printf("Toggle between Full Screen and Windowed [f]\n");
    printf("Increment Sigma +1.0\n");
    printf("Decrement Sigma -1.0\n");
    printf("Increment Sigma +0.1\n");
    printf("Decrement Sigma -0.1\n");
    printf("Set Order 0 [0]\n");
    printf("Set Order 1 [1]\n");
    printf("Set Order 2 [2]\n");
    printf("Quit <esc>\n");
    #else
    // create GLUT menu
    ...
    glViewport(0, 0, uiImageWidth, uiImageHeight);
    ...
    TexCoords[3][0] = 0.0f;
    TexCoords[3][1] = 0.0f;
    TexCoords[2][0] = uiImageWidth;
    TexCoords[2][1] = 0.0f;
    TexCoords[1][0] = uiImageWidth;
    TexCoords[1][1] = uiImageHeight;
    TexCoords[0][0] = 0.0f;
    TexCoords[0][1] = uiImageHeight;
...
{    
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, uiImageWidth, uiImageHeight, 0, GL_RGBA, GL_UNSIGNED_BYTE, 0);
...
void DisplayGL()
{
    ...
    if (bFilter)
    {
        ...
        glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, uiImageWidth, uiImageHeight, GL_RGBA, GL_UNSIGNED_BYTE, uiOutput);
