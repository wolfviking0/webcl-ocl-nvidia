...
{
    #ifdef __EMSCRIPTEN__
    printf("Toggle animation [ ]\n");
    printf("Increment isovalue [+]\n");
    printf("Decrement isovalue [-]\n");
    printf("Toggle computation [c]\n");
    printf("Toggle rendering [r]\n");
    printf("Toggle lighting [l]\n");
    printf("Toggle wireframe [w]\n");
    printf("Quit (esc)\n");
    #else
...
void renderIsosurface()
{
    ...
    glBindBuffer(GL_ARRAY_BUFFER_ARB, normalVbo);
