...
ParticleRenderer::DisplayMode displayMode = ParticleRenderer::PARTICLE_POINTS;//SPRITES_COLOR;
...
int numBodies = 256 * 64;          // default # of bodies in sim (can be overridden by command line switch --n=<N>)
...
shrBOOL bTour = shrFALSE;           // true = cycles between modes, false = stays on selected 1 mode (manually switchable)
